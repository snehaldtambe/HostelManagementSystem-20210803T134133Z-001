    ...
    <div class="contentform">
       ...
       <div class="leftcontact">
            <div class="form-group">
              ...
              <span class="icon-case"><i class="fa fa-male"></i></span>
                <input type="integer" name="id" id="id" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
      ...
      <div class="leftcontact">
            <div class="form-group">
              <p>Name<span>*</span></p>
              <span class="icon-case"><i class="fa fa-male"></i></span>
                <input type="text" name="fName" id="fName" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Nom' doit être renseigné."/>
                <div class="validation"></div>
       </div> 
        ...
        <input type="text" name="lName" id="lName" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Prénom' doit être renseigné."/>
                <div class="validation"></div>
      </div>
      ...
      <span class="icon-case"><i class="fa fa-home"></i></span>
        <input type="text" name="course" id="course" data-rule="required" data-msg="Vérifiez votre saisie sur les champs : Le champ 'Société' doit être renseigné."/>
                <div class="validation"></div>
      </div>
