...
if (isset($_POST['add'])) 
{
   ...
   if (isset($_POST['Quantity'])) {
      ...
      $Total_price = $Price * $Quantity;
        $query="insert into livestock values('".$Item_name."','".$Price."','".$Quantity."','".$Total_price."')";
        if($conn->query($query)==true)
        {
             echo"<script>
             alert('Stock added Successfully');
             Window.location.href='liveee.php'
              </script>";
        }
        else
        {
		...
		<div class="container-login100" style="padding-left:130px;">
			<div class="wrap-login100">
				<div class="login100-pic js-tilt" data-tilt>
					<img src="live123.jpg" alt="IMG">
				</div>
				<form class="login100-form validate-form " action=liveee.php " method="POST">
